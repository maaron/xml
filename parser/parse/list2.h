...
namespace list
{
    ...
    struct concat
    {
        static_assert(!list1_t::has_key<list2_t::key>::value, "Element indeces not unique");
    ...
    {
        static_assert(!list1_t::has_key<i>::value, "List already contains an element with the specified index");
